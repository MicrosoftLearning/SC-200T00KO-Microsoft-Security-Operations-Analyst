...
23. 이제 적절한 검색 규칙을 작성했으므로 쿼리가 표시된 로그 창의 명령 표시줄에서 **새 경고 규칙**을 선택하고 **Azure Sentinel 경고 만들기**를 선택합니다.
...
25. **규칙 논리 설정** 탭의 **규칙 쿼리 및 엔터티 매핑**에는 내용이 이미 입력되어 있습니다.
...
27. 나머지 옵션은 기본값으로 둡니다.  **다음: 인시던트 설정** 단추를 선택합니다.
...
**다음: 자동화된 응답** 단추를 선택합니다.

29. 자동화된 응답 탭에서 다음 항목을 설정합니다.

- Post-Message-Teams 선택
...
8. 보안 운영 센터 분석자가 위협을 정확하게 분석할 수 있도록 경고 관련 상황 정보를 최대한 많이 제공해야 합니다. 가령 조사 그래프에 사용할 엔터티 등을 제공할 수 있습니다.
...
```
9.  이제 적절한 검색 규칙을 작성했으므로 쿼리가 표시된 로그 창의 명령 표시줄에서 **새 경고 규칙**을 선택하고  **Azure Sentinel 경고 만들기**를 선택합니다.
...
12. 규칙 논리 설정 탭의 규칙 쿼리 및 엔터티 매핑에는 내용이 이미 입력되어 있습니다.
...
14. 나머지 옵션은 기본값으로 둡니다.  **다음: 인시던트 설정** 을 선택합니다.
...
7. 보안 운영 분석자가 위협을 정확하게 분석할 수 있도록 경고 관련 상황 정보를 최대한 많이 제공해야 합니다. 가령 조사 그래프에 사용할 엔터티 등을 제공할 수 있습니다.  다음 스크립트를 실행합니다.
...
8. 이제 적절한 검색 규칙을 작성했으므로 쿼리가 표시된 로그 창의 명령 표시줄에서 **새 경고 규칙**을 선택하고 **Azure Sentinel 경고 만들기**를 선택합니다.
...
12. 나머지 옵션은 기본값으로 둡니다.  **다음: 인시던트 설정** 을 선택합니다.
