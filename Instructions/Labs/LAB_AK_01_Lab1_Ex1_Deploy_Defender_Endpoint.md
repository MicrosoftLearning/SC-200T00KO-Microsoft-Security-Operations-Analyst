...
8. **설정** 페이지에서 **디바이스 검색**을 선택합니다.  검색 설정에서 **표준 검색**이 선택되었는지 확인합니다.  **설정** 페이지로 돌아갑니다.
...
4. 디바이스 온보딩 영역에서 배포 방법 드롭다운에 "로컬 스크립트(최대 디바이스 10대에 사용 가능)"가 표시되는지 확인하고 **패키지 다운로드** 단추를 선택합니다.
...
7. 디바이스 미리 보기 탭에서 미리 보기 표시를 선택하고 로컬 Windows 10 가상 머신을 확인합니다. **다음**을 선택합니다.
