...
7. **새 항목 추가**를 선택하고 메시지가 표시되면 관리자 Azure 구독 관리자 자격 증명으로 로그인합니다.

8. 팀의 **메시지 게시** 블록에서 편집 상자 끝에 있는 **X**를 선택합니다.  편집 상자가 Microsoft Teams에서 사용 가능한 팀 목록이 포함된 드롭다운으로 변경됩니다.  **SOC**를 선택합니다.

9. 채널에서 편집 상자 끝부분의 **X**를 선택합니다.  편집 상자가 채널 목록이 포함된 드롭다운으로 변경됩니다.  **새 경고**를 선택합니다.

10. 명령 모음에서 **저장**을 선택합니다.
